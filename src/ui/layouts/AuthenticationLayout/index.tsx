...
import VirtualCardMesh from "./components/VirtualCard/Canvas";

export default function AuthenticationLayout() {
  return (
    <div className="grid grid-cols-12 h-full">
      <div
        className="col-span-6 bg-gradient-to-r from-violet-600 from-10% via-violet-900 via-40%
        to-black to-90%"
      >
      ...
      <div className="col-span-6 relative bg-black text-white place-content-center overflow-hidden">
